...
public class CCPRestSDK {
	...
	/*
	* 此SDK所含方法
	* init,setAccount,setAppId,sendTemplateSMS,jsonToMap,xmlToMap,getHttpRequestBase,getmethodName,setHttpHeader,getBaseUrl,isEmpty,getMyError,accountValidate
	*
	* */
