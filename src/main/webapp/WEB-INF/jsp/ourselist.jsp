...
<div class="container padding-bottom">
    ...
    <div class="nav-bar">
        ...
        <c:forEach items="${lists}" var="list">
            <c:forEach items="${list}" var="task11">
                <a class="nav-bar-a" href="">${task11.head}</a>
            </c:forEach>
        </c:forEach>
    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                        <div class="warp-border">
                            <div class="clearfix">
                                ...
                                <div class="text">
                                    <h4 class="">${task11.name}</h4>
                                    <p class="text-present">${task11.speak}</p>
                                </div>
                            </div>
                            ...
                            <div class="warp-class2">
                                <div class="warp-class2-text">
                                    <div class="iconfont text-padding">门槛
                                        <c:forEach  begin="1" end="${task11.door}">
                                ...
                                <div class="warp-class2-text">
                                    <div class="iconfont text-padding text-border-left">难易程度
                                        <c:forEach begin="1" end="${task11.easy}">
                                            <img src="/photo/xx.png">
                                        </c:forEach>
                                    </div>
                                </div>
                            ...
                            <div class="warp-class2">
                                <div class="warp-class2-text">
                                    <div class="iconfont text-padding">成长周期 <span class="iconfont-color"></span>${task11.year}年</div>
                                </div>
                                <div class="warp-class2-text">
                                    <div class="iconfont text-padding text-border-left">稀缺程度 <span class="iconfont-color"></span>${task11.company}家公司需要</div>
                                </div>
                            </div>
                            ...
                            <div class="warp-class2">
                                ...
                                <div class="rightWarp">
                                    <div class="rightWarp-class">
                                        ...
                                        <div class="rightWarp-wages">${task11.money1}/月</div>
                                    </div>
                                    <div class="rightWarp-class">
                                        <div class="rightWarp-year">1-3年</div>
                                        <div class="rightWarp-wages">${task11.money2}月</div>
                                    </div>
                                    <div class="rightWarp-class border-bottom">
                                        <div class="rightWarp-year">3-5年</div>
                                        <div class="rightWarp-wages">${task11.money3}/月</div>
                                    </div>
                                </div>
                            </div>

                            <div class="warp-class2">
                                <b class="text-b">有${task11.learn}人正在学</b>
                            </div>
                            <div class="warp-class2">
                                <p class="text-p">提示:${task11.tips}</p>
                            </div>

                            <div class="flip-container">
                                <p class="flip-title">${task11.name}</p>
                                <p class="flip-text">${task11.tips}</p>
                            </div>
                        </div>
                    </div>
                </c:forEach>
